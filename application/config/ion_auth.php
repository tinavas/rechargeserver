...
$config['tables']['sms_details']                            = 'sms_details';
$config['tables']['user_sms_transactions']                  = 'user_sms_transactions';
...
$config['tables']['basic_configuration']                    = 'basic_configuration';
...
$config['message_codes']['5001']  = 'Invalid Amount.';
$config['message_codes']['5002']  = 'Low balance.';
$config['message_codes']['5003']  = '';
$config['message_codes']['5004']  = 'Subscription period is expired.';
$config['message_codes']['5005']  = '';
$config['message_codes']['5006']  = 'Server sql error occured.';
$config['message_codes']['5007']  = 'Server database error occured.';
$config['message_codes']['5008']  = 'Server error occured.';
