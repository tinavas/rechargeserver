...
<div class="mypage" style="width:100%;float:left;padding-bottom:0px;padding-left:30px;">
    <ul class="shortcurt">
        <li><a href="<?php echo base_url().'transaction/topup'?>"><img src="<?php echo base_url();?>resources/images/flexiload.png" onerror="this.onerror=null;this.src='resources/images/default.png';">Topup</a></li>						
        <li><a href="<?php echo base_url().'transaction/bkash'?>"><img src="<?php echo base_url();?>resources/images/bkash.png" onerror="this.onerror=null;this.src='resources/images/default.png';">bKash</a></li>						
        <li><a href="<?php echo base_url().'transaction/dbbl'?>"><img src="<?php echo base_url();?>resources/images/dbbl.png" onerror="this.onerror=null;this.src='resources/images/default.png';">DBBL</a></li>						
        <li><a href="<?php echo base_url().'transaction/mcash'?>"><img src="<?php echo base_url();?>resources/images/mcash.png" onerror="this.onerror=null;this.src='resources/images/default.png';">M-Cash</a></li>						
        <li><a href="<?php echo base_url().'transaction/ucash'?>"><img src="<?php echo base_url();?>resources/images/ucash.png" onerror="this.onerror=null;this.src='resources/images/default.png';">U-Cash</a></li>						
