<script type="text/javascript">
    ...
    function search_topup() {
        ...
        angular.element($("#search_submit_btn")).scope().getTopupTransactionList(startDate, endDate);
    }
</script>
...
<div class="mypage" ng-controller="transctionController">
    <ul class="list-unstyled paymentHistorySearch">
        ...
        <li><input id="search_submit_btn" type="submit" size="18" value="Submit" onclick="search_topup()" class="btn btn-xs btn-default"></li>
    </ul>
    ...
    <div class="other-controller">
        <div class="text-center">
            <dir-pagination-controls boundary-links="true" on-page-change="getTopupByPagination(newPageNumber)" template-url="<?php echo base_url(); ?>history/pagination_tmpl_load"></dir-pagination-controls>
        </div>
    </div>
</div>