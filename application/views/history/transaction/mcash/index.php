<script type="text/javascript">
    ...
    function search_mkash(searchInfo) {
...
<div class="mypage" ng-controller="transctionController" ng-init="setTransactionStatusList('<?php echo htmlspecialchars(json_encode($transction_status_list)) ?>')">
    <ul class="list-unstyled paymentHistorySearch">
        ...
        <li><input id="search_submit_btn" type="submit" size="18" value="Search" onclick="search_mkash(angular.element(this).scope().searchInfo)" class="button-custom"></li>
    </ul>
    <table class="table10"> 
        <thead>
            <tr>
