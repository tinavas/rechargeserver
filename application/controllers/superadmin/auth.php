...
class Auth extends CI_Controller {
    ...
    function login() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
                ...
                redirect('superadmin/auth/login', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
            }
        } else {
            ...
            $this->template->load(SUPER_ADMIN_LOGIN_TMPL, "superadmin/auth/login", $this->data);
 ...
 //superadmin pin
    function pin() {
        ...
        $this->template->load(SUPER_ADMIN_LOGIN_TMPL, "superadmin/auth/pin", $this->data);
    }
