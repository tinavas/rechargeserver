...
class Transaction extends CI_Controller {
    ...
    /*
     * This method will show transaction list page
     * @autor nazmul hasan on 9th october 2016
     */
    public function get_transaction_list() {
        ...
        if (file_get_contents("php://input") != null) {
            ...
            $transction_list_array = $this->transaction_library->get_transaction_list(array(), $service_id_list, $status_id_list, $transaction_process_types, $cell_no, $from_date, $to_date, $offset, $limit);
        ...
        $transction_list_array = $this->transaction_library->get_transaction_list(array(), $service_id_list, $status_id_list, $transaction_process_types, '', $current_date, $current_date, $offset, $limit);
